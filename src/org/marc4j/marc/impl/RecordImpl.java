...
public class RecordImpl implements Record {
	 ...
	 * record already has a control number field, the field will be replaced with
	 * the new instance by default. CDL changed this method to allow multiple 001 
	 * fields because they are present in the data. Constraint on multiple 001s
	 * should be implemented at the application level.
	 * 
	 * CDL change to return unsorted collection
	 * <code>DataFields<code> and <code>ControlFields<code>
	 * 
	 * @param field
